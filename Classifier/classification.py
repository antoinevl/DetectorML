...
def cross_validation_scores(X, y, clf): 
    ...
    print "PPP: %0.2f" % basic_metrics['PPP']
    print "NPP: %0.2f" % basic_metrics['NPP']
    print "Specificity: %0.2f" % basic_metrics['specificity']
    print "Sensitivity or recall: %0.2f" % basic_metrics['sensitivity']
    print "Recall or sensitivity:  %0.2f" % recall_score(y_true, y_pred)
    print "Accuracy score:  %0.2f" % accuracy_score(y_true, y_pred)
    print "F1 score:  %0.2f" % f1_score(y_true, y_pred)
    print "F2 score:  %0.2f" % fbeta_score(y_true, y_pred, 2)
    print "Precision score:  %0.2f" % precision_score(y_true, y_pred)
